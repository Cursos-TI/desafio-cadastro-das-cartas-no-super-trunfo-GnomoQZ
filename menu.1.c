...
void exibir_cartas(carta_A ficha[], int num_cartas) {
    ...
    for (int i = 0; i < num_cartas; i++) {
        ...
        printf("Código da cidade: \033[1;34m%s\033[0m\n", ficha[i].codigo_cidade);  // Azul para o código
        printf("Nome da cidade: \033[1;34m%s\033[0m\n", ficha[i].nome_cidade);  // Azul para o nome
        printf("Número da população: \033[1;34m%d\033[0m\n", ficha[i].populacao);
        printf("Número de pontos turísticos: \033[1;34m%d\033[0m\n", ficha[i].ponto_turistico);
        printf("PIB da cidade: \033[1;34m%d\033[0m\n", ficha[i].pib);
        printf("Área da cidade: \033[1;34m%.2f km²\033[0m\n", ficha[i].area);
        printf("Densidade demográfica: \033[1;34m%.2f hab/km²\033[0m\n\n", ficha[i].densidade);
    }
}
